...
<s:select style="width:300px" name="user" list="userDevList" onchange="enableSubmitButton()" labelposition="left" label="SELECT A USER"  listKey="idUser" listValue="name" id="idUser"  headerKey="none" headerValue="--Select--" />
