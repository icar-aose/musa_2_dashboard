...
<s:if test='#session.root=="on"'>
	...
	<a class="active">INSTANCES FOR CONCRETE CAPABILITY</a>
</div></div>
...
<s:div  cssClass="mainDiV">
		...
		<s:a cssClass="ui-button ui-widget ui-corner-all"   href="%{actionLogCapabilityURL}">ACTION LOG</s:a>
		</display:column>
		</display:table>
...
<s:property value="#session['logcase_dev']"/>
<s:if test='#session["link_logcase_dev"] != ""'>
<a href="<s:property value="#session['link_logcase_dev']"/>" target="_blank"> (MORE INFO)</a>
</s:if>
</s:div>
</body>
</html>