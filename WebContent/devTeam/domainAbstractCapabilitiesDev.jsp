...
<display:table export="false" id="alternatecolor" name="abstractCapabilitiesList" pagesize="5" class="altrowstable"  uid="row" requestURI="listDomainAbstractCapabilitiesDev"  style="margin-bottom:20px;">
