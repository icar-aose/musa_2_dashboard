...
<%-- 				<s:a  cssClass="ui-button ui-widget ui-corner-all" href="%{deleteURL}">DELETE OLD</s:a> --%>
 ...
 <tr>
  <td>
  <s:url id="newURL" action="newDomainAbstractCapabilities" escapeAmp="false">
					<s:param name="operation_name" value="%{'edit'}"></s:param>
					<s:param name="idDomain" value="%{#parameters.idDomain}"></s:param>
				</s:url> 
				<s:a cssClass="ui-button ui-widget ui-corner-all"  href="%{newURL}">NEW ABSTRACT CAPABILITY</s:a>
