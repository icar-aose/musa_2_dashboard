...
public class CapabilityLogDAO {
	...
	public List<CapabilityLog> getAllCapabilityLogByCapability(ConcreteCapability concreteCapability) {
		...
		Query query = session.createQuery(
				"select cl from CapabilityInstance as ci, CapabilityLog as  cl where ci.concreteCapability= :concreteCapability and ci.idCapabilityInstance=cl.capabilityInstance");
