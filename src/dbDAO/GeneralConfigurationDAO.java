...
public class GeneralConfigurationDAO {
	...
	public  GeneralConfiguration  getGeneralConfigurationByID(Integer idGeneralConfiguration)
	{
		  ...
		  Session session = sessionFactory.openSession();
		  session.beginTransaction();
		  GeneralConfiguration generalConfigurationDB = (GeneralConfiguration)session.get(GeneralConfiguration.class,idGeneralConfiguration);
	...
	public void deleteGeneralConfiguration(int idGeneralConfiguration){
		 SessionFactory sessionFactory = HibernateUtil.getSessionFactory();
		  Session session = sessionFactory.openSession();
		  session.beginTransaction();
		  GeneralConfiguration generalConfiguration = (GeneralConfiguration)session.load(GeneralConfiguration.class, idGeneralConfiguration);
