...
public class FunctionalReqRelAction extends ActionSupport implements ModelDriven<FunctionalReqRelations> {
	...
	public String deleteFunctionalReqRel() {
		...
		if (request.getParameter("idFuncReqRel") != null) {
			functionalReqRel = functionalReqRelationsDAO
					.getFunctionalReqRelById(Integer.parseInt((request.getParameter("idFuncReqRel"))));
	...
	public String edit() {
		...
		if (request.getParameter("idFuncReqRel") != null) {
			...
			this.setIdfunctionalReqByIdStart(
					functionalReqRel.getFunctionalReqByIdStart().getIdFunctionalReq().toString());
		}
