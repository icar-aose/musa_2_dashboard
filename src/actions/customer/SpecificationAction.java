...
public class SpecificationAction extends ActionSupport implements ModelDriven<Specification> {
	...
	public String listDomainSpecification() {
		...
		// domainSpecificationList=
		// specificationDAO.getAllSpecificationByDomain(domain);
		return SUCCESS;
	}
	...
	public String changeStateSpecification() {
		...
		HttpServletRequest request = (HttpServletRequest) ActionContext.getContext()
				.get(ServletActionContext.HTTP_REQUEST);
		specification = specificationDAO
				.getSpecificationById(Integer.parseInt((request.getParameter("idSpecification"))));
		...
		String res = classeInvioMsg.sendMsg(connection,
				"SPECIFICATION: " + specification.getName() + " STATE: " + specification.getState());
	...
	public void setDomainSpecificationList(List<Specification> domainSpecificationList) {
