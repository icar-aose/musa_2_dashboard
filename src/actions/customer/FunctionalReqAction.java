...
public class FunctionalReqAction extends ActionSupport implements ModelDriven<FunctionalReq> {
	...
	public String deleteFunctionalReq() {
		...
		if (request.getParameter("idFunctionalReq") != null) {
			functionalReq = functionalReqDAO
					.getFunctionalReqById(Integer.parseInt((request.getParameter("idFunctionalReq"))));
	...
	public String changeStateFunctionalReq() {
		...
		String res = classeInvioMsg.sendMsg(connection,
				"FUNCTIONAL REQ: " + functionalReq.getName() + " STATE: " + functionalReq.getCurrentState());
