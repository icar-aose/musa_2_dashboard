...
public class ConcreteCapabilityAction extends ActionSupport implements ModelDriven<ConcreteCapability> {
	...
	public String newConcreteCapability() {
		switch (msg) {
		case "1":
			this.setTextMsg("Jar Non Valido");
			break;
		case "2":
			this.setTextMsg("Classe non Valida");
			break;
		default:
			this.setTextMsg("");
		}
	...
	public String listConcreteCapabilities() {
		AbstractCapability abstractCapability = abstractCapabilityDAO
				.getAbstractCapabilityByID(Integer.parseInt(idAbstractCapability));
	...
	public String edit() {
		...
		concreteCapability = concreteCapabilityDAO
				.getConcreteCapabilityByID(Integer.parseInt(request.getParameter("id")));
		return SUCCESS;
	}
	...
	public String listConcreteCapabilitiesDev() {
		...
		concreteCapabilitiesList = concreteCapabilityDAO.getAllConcreteCapabilityByAbstractUserDev(abstractCapability,
				user);
		return SUCCESS;
	}
	...
	public String changeStateConcreteCapability() {
		...
		String res = classeInvioMsg.sendMsg(connection,
				"CONCRETE CAPABILITY: " + concreteCapability.getName() + " STATE: " + concreteCapability.getState());
	...
	public String changeDeployConcreteCapability() throws SQLException {
		...
		if (statedeploy.equals("deployed")) {
			...
			String res = classeInvioMsg.sendMsg(connection, "CONCRETE CAPABILITY: " + concreteCapability.getName()
					+ " DEPLOY STATE: " + concreteCapability.getDeploystate());
			if (!res.equals("INVIATO")) {
				return ("erroreMQ");
			}
		} else {
			...
			String nomefile = concreteCapability.getIdConcreteCapability().toString() + concreteCapability.getName()
					+ ".jar";
	...
	public void setConcreteCapabilitiesList(List<ConcreteCapability> concreteCapabilitiesList) {
		this.concreteCapabilitiesList = concreteCapabilitiesList;
	}

	public void setAbstractCapabilitiesList(List<AbstractCapability> abstractCapabilitiesList) {
	...
	public void setCapabilityInstanceList(List<CapabilityInstance> capabilityInstanceList) {
