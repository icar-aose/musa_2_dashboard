...
public class GeneralConfigurationAction extends ActionSupport implements ModelDriven<GeneralConfiguration> {
	...
	public String edit() {
		HttpServletRequest request = (HttpServletRequest) ActionContext.getContext()
				.get(ServletActionContext.HTTP_REQUEST);
		generalConfiguration = generalConfigurationDAO
				.getGeneralConfigurationByID(Integer.parseInt(request.getParameter("id")));
		generalConfigurationList = generalConfigurationDAO.getAllGeneralConfiguration();
	...
	public void setGeneralConfigurationList(List<GeneralConfiguration> generalConfigurationList) {
