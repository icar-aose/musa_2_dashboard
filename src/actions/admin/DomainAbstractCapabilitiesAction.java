...
public class DomainAbstractCapabilitiesAction extends ActionSupport implements ModelDriven<AbstractCapability> {
	...
	public String edit() {
		...
		abstractCapability = abstractCapabilityDAO
				.getAbstractCapabilityByID(Integer.parseInt(request.getParameter("id")));
		Domain domain = domainDAO.getDomainByID(Integer.parseInt(idDomain));
		abstractCapabilitiesList = abstractCapabilityDAO.getAllAbstractCapabilityByDomain(domain);
	...
	public String verifyProposalExist() {
		...
		AbstractCapability abstractCapabilityDB = abstractCapabilityDAO
				.getAbstractCapabilityByID(Integer.parseInt(request.getParameter("idAbstratCapability")));
		AbstractCapabilityProposalDAO abstractCapabilityProposalDAO = new AbstractCapabilityProposalDAO();
		List<AbstractCapabilityProposal> abstractCapabilityProposals = abstractCapabilityProposalDAO
				.getProposalByAbstractCapability(abstractCapabilityDB);
